...
BEGIN {
	...
	ERROR_MONITOR_NO_DESCRIPTOR => 2149978113,
	ERROR_MONITOR_UNKNOWN_DESCRIPTOR_FORMAT => 2149978114,
...
our %EXPORT_TAGS = (
    ...
    WINSOCK => [qw(
	WSAEDQUOT WSAEREFUSED WSAEDESTADDRREQ WSAEPFNOSUPPORT
	WSAEINVALIDPROCTABLE WSAENOMORE WSAECONNRESET WSAEOPNOTSUPP WSAEACCES
	WSAEHOSTUNREACH WSAENETDOWN WSAEISCONN WSAEUSERS WSAENAMETOOLONG
	WSAENOTCONN WSAECANCELLED WSAENOPROTOOPT WSAETOOMANYREFS WSAEDISCON
	WSAEINVALIDPROVIDER WSAESOCKTNOSUPPORT WSAELOOP WSAENETRESET
	WSAEREMOTE WSAESHUTDOWN WSAETIMEDOUT WSAEPROTONOSUPPORT WSAEBADF
	WSAEALREADY WSAEADDRINUSE WSAECONNREFUSED WSAESTALE WSAENOBUFS
	WSAENOTSOCK WSAEHOSTDOWN WSAEAFNOSUPPORT WSAENOTEMPTY WSAEPROTOTYPE
	WSAEINVAL WSAECONNABORTED WSAEADDRNOTAVAIL WSAEMSGSIZE
	WSAEPROVIDERFAILEDINIT WSAEINPROGRESS WSAEFAULT WSAENETUNREACH
	WSAEINTR WSAEMFILE WSAEPROCLIM WSAEWOULDBLOCK
    )],
);
